<?php
    ...
    if (isset($_GET['id_anggota'])) {
        ...
        if (isset($_POST['update'])) {
            ...
            $query = "UPDATE data_anggota SET nama='$nama', gender='$gender', jurusan='$jurusan', prodi='$prodi', jenis='$jenis', email='$email', notelp='$notelp' WHERE id_anggota='$id_anggota' ";
                      ...
                      <script>
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" id="jenis" name="jenis" required>
                              <option value="Mahasiswa" <?php echo ($row['jenis'] == 'Mahasiswa') ? 'selected' : ''; ?>>Mahasiswa</option>
                              <option value="Dosen" <?php echo ($row['jenis'] == 'Dosen') ? 'selected' : ''; ?>>Dosen</option>
                              <option value="Pegawai" <?php echo ($row['jenis'] == 'Pegawai') ? 'selected' : ''; ?>>Pegawai</option>
                          </select>
                    </div>
                    <div class="form-group">
