                                                  ...
                                                  <tr>
                                                      ...
                                                      <td><?php 
                                                            ...
                                                            $lambat=terlambat($tgl_dateline, $tgl_kembali);
                                                                ...
                                                                $denda=$lambat*$denda1;
                                                            if ($lambat>0) {
                                                                echo "<center><b><font color='red'> Keterlambatan = $lambat hari  &nbsp | &nbsp(Rp. $denda1,- x $lambat) = Rp. $denda,-</font></b></center>";
                                                            }
                                                            else {
                                                              echo "<center><b><font color='black'></font></b></center>";
                                                            }
                                                              ?>
                                                      </td>
                                                      <?php
